      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content1">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Registration Page</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Registration</h4>
                      <form class="form-horizontal style-form" name="registration" id="registrationform" method="POST" action="registration_confirm.php">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input class="form-control" name="email" type="email" placeholder="bob@gmail.com">
                              </div>
                          </div>
				<div class="form-group">
				...
				<div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input class="form-control" name="phno" type="text" placeholder="9231324233">
                              </div>
                          </div>
                           <div class="form-group">
			...
			<div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="password" name="repwd" id="repwd" onChange="checkPasswordMatch();" class="form-control">
                                  <span class="help-block" id="divCheckPasswordMatch"></span>	
                              </div>
                          </div>
