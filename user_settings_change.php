...
if($_POST['smsalert']=="yes")$smsalert=1;else $smsalert=0;
if($_POST['emailalert']=="yes")$emailalert=1;else $emailalert=0;


$qry="UPDATE User SET smsalert=$smsalert, emailalert=$emailalert where uid='$_SESSION[uid]' AND upwd='$_SESSION[pwd]'";
$result=mysqli_query($con,$qry);

if($result)
{
echo "Values Saved"."<br/>";

}
else
{
echo "Values Not Saved"."<br/>";
}
