...
$_SESSION['NAME'] = $fname;
$_SESSION['emailalert']=$row['emailalert'];
$_SESSION['smsalert']=$row['smsalert'];
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> My Settings </h3>
          	
          	<br/>
          	
    		<form method="POST" action="user_settings_change.php">
		                        <div class="animated fadeInLeft">
                            <span style="font-weight:bold;font-size:22px;">  Recieve SMS</span><br/>
		                               <td><input type="checkbox" data-toggle="switch" name="smsalert" value="yes" <?php session_start();echo ($_SESSION['smsalert']==1 ? 'checked' : '');?>></div><br/><br/>
				
				<div class="animated fadeInLeft">

                             <span style="font-weight:bold;font-size:22px;">  Recieve Email</span><br/>
		                               <input type="checkbox" data-toggle="switch" name="emailalert" value="yes" <?php  session_start(); echo($_SESSION['emailalert']==1 ? 'checked' : '');?>><br/><br/>
</div>							              
